import type { ContextDefinition } from '@code-story/core';
 ...
 *
 * Only code that is NOT itself part of the diff reaches here — callees with their own chunk are
 * filtered out upstream (visibleDefinitions), so the "not part of the diff" caption is always true
 * and there is no per-definition "in this diff" badge.
 */
